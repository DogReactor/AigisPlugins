...
local fileNames = {ClassInfos="PlayerUnitTable.aar",NameText="NameText.atb",SkillList="SkillList.atb"}
local filePath = {ClassInfos="\\002_ClassData.atb\\ALTB_cldt.txt",NameText="\\ALTB_gdtx.txt",SkillList="\\ALTB_skil.txt"}
print(filePath[file])
